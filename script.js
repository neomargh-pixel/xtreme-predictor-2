...
/*
==================================================
RENDER DE INFORMACIÓN DE CABALLO
==================================================
*/
...
function pintarCaballosDestacados(
  datos
) {
  ...
  if (
    ...
    contenedor.innerHTML = `
      <p>
        ⏳ Todavía no hay caballos destacados.
      </p>
    `;
...
function pintarCarrerasCaballos(
  datos
) {
