...
import guardarResultadosGranjita from "../lib/guardarResultadosGranjita.js";
...
const BASE =
  "https://lotoven.com/animalito/lagranjita";
...
async function obtenerMapaNumeros() {
  ...
  if (!respuesta.ok) {
    ...
    throw new Error(
      "No se pudo obtener la tabla de animales de La Granjita."
    );
  ...
  */
  ...
  if (
    ...
    throw new Error(
      "La tabla de La Granjita no pudo ser identificada correctamente."
    );
...
async function obtenerSemana(
  ...
  if (!respuesta.ok) {
    ...
    throw new Error(
      `No se pudo obtener el historial de La Granjita ${inicio} al ${fin}.`
    );
            ...
            (i, celda) => {
              ...
              */
              ...
              if (
                ...
                console.log(
                  `La Granjita - animal sin número: ${animal}`
                );
  ...
  try {
    ...
    */
    ...
    if (
      ...
      throw new Error(
        "No se encontraron resultados históricos de La Granjita."
      );
    ...
    */
    ...
    await guardarResultadosGranjita(
      resultados
    );
